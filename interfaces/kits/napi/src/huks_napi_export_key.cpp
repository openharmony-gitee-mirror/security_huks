...
{
    ExportKeyAsyncContext *context = (ExportKeyAsyncContext *)HksMalloc(sizeof(ExportKeyAsyncContext));
    if (context != nullptr) {
        (void)memset_s(context, sizeof(ExportKeyAsyncContext), 0, sizeof(ExportKeyAsyncContext));
    }
    return context;
}
