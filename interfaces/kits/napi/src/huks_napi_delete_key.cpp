...
{
    DeleteKeyAsyncContext *context = (DeleteKeyAsyncContext *)HksMalloc(sizeof(DeleteKeyAsyncContext));
    if (context != nullptr) {
        (void)memset_s(context, sizeof(DeleteKeyAsyncContext), 0, sizeof(DeleteKeyAsyncContext));
    }
    return context;
}
