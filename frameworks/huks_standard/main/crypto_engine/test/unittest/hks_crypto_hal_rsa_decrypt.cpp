...
const char RSA_2048_PKCS1PADDING_KEY[] =
...
HWTEST_F(HksCryptoHalRsaDecrypt, HksCryptoHalRsaDecrypt_001, Function | SmallTest | Level1)
{
    ...
    const char *hexData = "4af9454165afd9ad50635a7f18858dd3693a9713604971572824fff91cee16fb80169977eb1a91afe8e2ad401e1"
...
HWTEST_F(HksCryptoHalRsaDecrypt, HksCryptoHalRsaDecrypt_003, Function | SmallTest | Level1)
{
    ...
    const char *hexData = "88455132d720d77b04128a201f6c1fa234568c368cc4f57d1381316c80e32d3874f5a30f2be6cebbb960ef2a526"
...
HWTEST_F(HksCryptoHalRsaDecrypt, HksCryptoHalRsaDecrypt_007, Function | SmallTest | Level1)
{
    ...
    const char *hexData = "0716c17114c78dc6000d72b612174e6ac6b42cc2b7aeeb3651dffc92741a6396360368cc8a3f43629a78ef56231"
...
HWTEST_F(HksCryptoHalRsaDecrypt, HksCryptoHalRsaDecrypt_009, Function | SmallTest | Level1)
{
    ...
    const char *hexData = "29bbe6754eba61b5b2907a73f03d4c3d21ec3b15296f78cc12bc870eaea302e2f1f0703c53d9a8ead057079affc"
...
HWTEST_F(HksCryptoHalRsaDecrypt, HksCryptoHalRsaDecrypt_010, Function | SmallTest | Level1)
{
    ...
    uint32_t keyLen = strlen(RSA_2048_PKCS1PADDING_KEY) / 2;
    HksBlob key = {.size = keyLen, .data = (uint8_t *)HksMalloc(keyLen)};
    for (uint32_t ii = 0; ii < keyLen; ii++) {
        key.data[ii] = ReadHex((const uint8_t *)&RSA_2048_PKCS1PADDING_KEY[2 * ii]);
    }
